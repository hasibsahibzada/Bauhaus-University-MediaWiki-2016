...
# skin valid name
$wgValidSkinNames['bauhausmediawikiexptv'] = 'BauhausMediaWikiexptv';
...
class SkinBauhausMediaWikiexptv extends SkinBauhausMediaWiki {

	/** Using Bootstrap */
	public $skinname 		= 'bauhaus-mediawikiexptv';
	public $stylename 		= 'bauhaus-mediawikiexptv';
	public $template 		= 'BauhausMediaWikiexptvTemplate';
 ...
 * @subpackage Skins
 */
class BauhausMediaWikiexptvTemplate extends BauhausMediaWikiTemplate {
	/**
	...
	function initPrfs() {
		...
		$this->templPrefs['skin_indicator_en']	= 'Experimental Television';
		$this->templPrefs['skin_indicator_de']	= 'Experimentelle Television';
