...
# skin valid name
$wgValidSkinNames['bauhausmediawikimoden'] = 'BauhausMediaWikimoden';
...
class SkinBauhausMediaWikimoden extends SkinBauhausMediaWiki {

	/** Using Bootstrap */
	public $skinname 		= 'bauhaus-mediawikimoden';
	public $stylename 		= 'bauhaus-mediawikimoden';
	public $template 		= 'BauhausMediaWikimodenTemplate';
 ...
 * @subpackage Skins
 */
class BauhausMediaWikimodenTemplate extends BauhausMediaWikiTemplate {
	/**
	...
	function initPrfs() {
		...
		$this->templPrefs['mySubtitle']			= 'Media, Trend & Public Appearance / Prof. Christine Hill';
		...
		$this->templPrefs['myHomeURL']			= 'http://web.uni-weimar.de/medien/wiki/MODEN:Start'; // Link of $mySubtitle
		...
		$this->templPrefs['mySubtitle_de']		= 'Moden und &ouml;ffentliche Erscheinungsbilder / Prof. Christine Hill';
		// extra HTML
		...
		$this->templPrefs['skin_indicator_en']	= 'Moden & öffentl. Erscheinungsbilder';
		$this->templPrefs['skin_indicator_de']	= 'Moden & öffentl. Erscheinungsbilder';
